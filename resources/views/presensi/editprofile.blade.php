...
@section('content')
    ...
    <form action="{{ route('presensi.updateprofile', ['username' => $karyawan->username]) }}" method="POST"
        ...
        <div class="col">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="text" class="form-control" value="{{ $karyawan->nik }}" name="nik"
                                placeholder="NIK/NIP" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-6">
            ...
            <div class="form-group boxed">
                <div class="input-wrapper">
                    <input type="text" class="form-control" value="{{ $karyawan->jabatan }}" name="jabatan"
